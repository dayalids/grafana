...
- **uid** – Provide another [unique identifier](/http_api/folder/#identifier-id-vs-unique-identifier-uid) than stored to change the unique identifier. Starting with 10.1, this is **deprecated**. It will be removed in a future release. Please avoid using it because it can result in folder loosing its permissions.
- **title** – The title of the folder.
